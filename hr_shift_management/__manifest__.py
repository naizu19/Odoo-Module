...
See README.md and static/description/index.html for full documentation.
    ...
    'assets': {
        'web.assets_backend': [
            'hr_shift_management/static/src/dashboard/shift_dashboard.scss',
            'hr_shift_management/static/src/dashboard/shift_dashboard.xml',
            'hr_shift_management/static/src/dashboard/shift_dashboard.js',
        ],
    },
    'installable': True,
    'application': True,
