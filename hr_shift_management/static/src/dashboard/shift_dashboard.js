...
export class ShiftManagementDashboard extends Component {
    static template = "hr_shift_management.ShiftDashboard";
    ...
    openShifts() {
        return this.openAction("hr_shift_management.hr_shift_template_action");
    }

    openAssignments() {
        return this.openAction("hr_shift_management.hr_shift_assignment_action");
    }

    openChangeRequests() {
        return this.openAction("hr_shift_management.hr_shift_change_request_action");
    }
